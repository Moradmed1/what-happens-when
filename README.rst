...
* The server breaks down the request to the following parameters:
   * HTTP Request Method (either ``GET``, ``HEAD``, ``POST``, ``PUT``,
     ...
     #what
     GET REQUEST
     The GET method is used to retrieve information from the given server using a given URIgit add.
     Reuests usign GET should only retrieve data and would have no other effet on a data.
